<?php 
	...
	switch ($TOOLBAR_ORDER_BY){
		case 'title-asc':
			$mysql_order_by = 'GL_ALIAS ASC';
			break;
		case 'title-desc':
			$mysql_order_by = 'GL_ALIAS DESC';
			break;
		case 'rank-asc':
			$mysql_order_by = 'G_RANK ASC';
			break;
		case 'rank-desc':
			$mysql_order_by = 'G_RANK DESC';
			break;
		case 'visible-asc':
			$mysql_order_by = 'G_VISIBLE ASC';
			break;
		case 'visible-desc':
			$mysql_order_by = 'G_VISIBLE DESC';
			break;
		default:
			$mysql_order_by = 'GL_ALIAS ASC';
	}
?>
<div id = "toolbar">
	<select id = "lang" title = "Επιλογή γλώσσας αποτελεσμάτων" onchange = "javascript:refreshListG('<?php echo $TOOLBOX_FILE; ?>', this.value, '<?php echo $TOOLBAR_ORDER_BY; ?>');">
		<?php
	...
	<select id = "order-by" title = "Ταξινόμηση αποτελεσμάτων" onchange = "javascript:refreshListG('<?php echo $TOOLBOX_FILE; ?>', '<?php echo $TOOLBAR_LANG; ?>', this.value);">
