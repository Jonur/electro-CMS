<?php
	...
	if ($valid_entry)
	{
		...
		$sql_nl = "UPDATE `electro_users` SET EU_USERNAME = '$form_eu_username', EU_EMAIL='$form_eu_email' $set_password WHERE EU_ID = '$form_id'";
		//echo $sql_nl;return;
		...
		$elog_action = "Αλλαγή Προφίλ Χρήστη electro με username ".$form_eu_username;
		eLog($elog_action);
	...
	//Redirection
	header('Location: ../?action=electro_users_profile&validation='.$valid_entry);
?>